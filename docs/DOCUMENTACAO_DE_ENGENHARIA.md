...
* **Persistência de Dados:** **PostgreSQL** como banco de dados relacional (SGBDR), utilizando **SQLAlchemy** (com driver assíncrono **asyncpg**) para comunicação entre o backend em FastAPI e o banco de dados.
