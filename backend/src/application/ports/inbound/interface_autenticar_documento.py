...
órgão externo). Por isso a saída é um *espelho de conferência* — nenhum dado
pessoal dos envolvidos, nenhum endereço, nenhuma narrativa (RNF02, LGPD).
"""
...
class DocumentoAutenticadoOutput:
    ...
    situacao: str  # VALIDO | ADULTERADO
    emitido_em: str
    consultado_em: str
    natureza: str
    data_hora_fato: str
